...
<form method="post" action="index.php?sayfa=update">
<input style="display:none;" name="link" value="ayarlar">
  ...
  <div class="form-group col-md-6">
	  ...
	  <div class="form-group col-md-6">
      <label for="inputesim4">Resim</label>
      <input type="text" class="form-control" id="inputresim4" value="<?php echo bilgicek('resim_profil'); ?>" name="resim_profil">
    </div>
  </div>
